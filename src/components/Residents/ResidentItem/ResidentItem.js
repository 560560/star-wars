    ...
    if (!person) return <Preloader/>
        ...
        return (
            <div className="planetItemWrapper">
                <Container className={isFetching ? "foggy text-center residentItemContainer" : "text-center residentItemContainer"}>

                    <Row className="pt-5 mb-5 align-items-center">
                        <Col className="col-sm-5 text-lg-right text-md-right text-sm-center pl-sm-5 pb-sm-0 pb-3"><img src={emptyImg} width={200} alt={person.name}/></Col>
